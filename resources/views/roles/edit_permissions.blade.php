                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="form-check d-flex justify-content-center">
                                        <input type="checkbox" name="{{ $module->slug }}[]" value="read" class="form-check-input" {{ $role->hasPermission('read', $module->slug) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="form-check d-flex justify-content-center">
                                        <input type="checkbox" name="{{ $module->slug }}[]" value="create" class="form-check-input" {{ $role->hasPermission('create', $module->slug) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="form-check d-flex justify-content-center">
                                        <input type="checkbox" name="{{ $module->slug }}[]" value="update" class="form-check-input" {{ $role->hasPermission('update', $module->slug) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="form-check d-flex justify-content-center">
                                        <input type="checkbox" name="{{ $module->slug }}[]" value="delete" class="form-check-input" {{ $role->hasPermission('delete', $module->slug) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td></td>
                            </tr>
