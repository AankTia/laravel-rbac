                    ...
                    <div id="accordionOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample"
                        ...
                        <div class="accordion-body">
                            <form action="{{ route('users.index') }}" method="GET">
                                <div class="row">
                                    <div class="col-md-4">
                                        <input class="form-control form-control-sm mb-3" type="text" name="search_name"
                                            value="{{ request('search_name') }}" placeholder="Name">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <select name="search_status" class="form-select form-select-sm mb-3">
                                            ...
                                            <option value="active"
                                                {{ request('search_status') === 'active' ? 'selected' : '' }}>Active
                                            </option>
                                            <option value="inactive"
                                                {{ request('search_status') === 'inactive' ? 'selected' : '' }}>Inactive
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <select name="search_role" class="form-select form-select-sm mb-3">
                                            ...
                                            @foreach ($roleOptions as $slug => $name)
                                                <option value="{{ $slug }}"
                                                    {{ request('search_status') == $slug ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                    ...
                    <tbody>
                        @forelse ($users as $user)
                            <tr>
                                <td>
                                    <div class="user-info">
                                        ...
                                        <div class="user-details">
                                            <p class="user-name"><a
                                                    href="{{ route('users.show', $user) }}">{{ $user->name }}</a></p>
                                ...
                                <td class="text-end">
                                    {!! permittedShowButtonIcon(route('users.show', $user), 'read', 'user') !!}
                                    {!! permittedEditButtonIcon(route('users.edit', $user), 'update', 'user') !!}
                                    {!! permittedDeleteButtonIcon(route('users.destroy', $user), 'delete', 'user') !!}
                                </td>
                            </tr>
                        @empty
                            <tr>
