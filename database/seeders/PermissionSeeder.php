...
class PermissionSeeder extends Seeder
{
    ...
    private function assignModulePermissions($permissionsIdBySlug)
    {
        ...
        $modulePermissions = [
            'dashboard' => ['read'],
            'user' => ['read', 'create', 'update', 'delete', 'activate', 'deactivate'],
            'role' => ['read', 'create', 'update', 'delete', 'update-role-permissions']
        ];
    ...
    private function assignPermissionRoleModule($permissionsIdBySlug)
    {
        ...
        $rolePermissionData = [
            'admin' => [
                'dashboard' => ['read'],
                'user' => ['read', 'create', 'update', 'activate', 'deactivate'],
                'role' => ['read', 'update-role-permissions']
            ],
            'viewer' => [
                'dashboard' => ['read'],
                'user' => ['read']
